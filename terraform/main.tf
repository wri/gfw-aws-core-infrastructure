...
<<<<<<< Updated upstream
  source         = "git::https://github.com/wri/gfw-terraform-modules.git//terraform/modules/storage?ref=v0.4.2.8-beta16"
=======
<<<<<<< Updated upstream
  source         = "git::https://github.com/wri/gfw-terraform-modules.git//terraform/modules/storage?ref=v0.4.0"
=======
  source         = "git::https://github.com/wri/gfw-terraform-modules.git//terraform/modules/storage?ref=v0.4.2.8-beta17"
>>>>>>> Stashed changes
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
  source        = "git::https://github.com/wri/gfw-terraform-modules.git//terraform/modules/secrets?ref=v0.4.2.8-beta16"
=======
<<<<<<< Updated upstream
  source        = "git::https://github.com/wri/gfw-terraform-modules.git//terraform/modules/secrets?ref=v0.4.0"
=======
  source        = "git::https://github.com/wri/gfw-terraform-modules.git//terraform/modules/secrets?ref=v0.4.2.8-beta17"
>>>>>>> Stashed changes
>>>>>>> Stashed changes
  project       = var.project_prefix
  name          = "gfw-api/token"
